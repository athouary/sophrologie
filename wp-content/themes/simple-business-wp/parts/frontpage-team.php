                ...
                <div class="col-md-12">
                    ...
                    <div class="centered">
                        <div class="team-item" data-sr="wait 0.3s, enter right and move 50px after 1s">
                            <img class="img-responsive img-circle center-block" src="<?php echo get_home_url(); ?>/wp-content/uploads/2021/08/Portrait.jpeg" alt="Nathalie Thouary Solon Sophrologue certifiée" />
