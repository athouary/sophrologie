    ...
    <section id="<?php if (simple_business_wp_get_option('fp-team-slug')=='') {echo "team";} else {echo esc_attr(simple_business_wp_get_option('fp-team-slug'));} ?>" class="frontpage-team">
        <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="centered">
                        <div class="team-item" data-sr="wait 0.3s, enter right and move 50px after 1s">
                            <img class="img-responsive img-circle center-block" src="<?php echo get_home_url(); ?>/wp-content/uploads/2021/08/Portrait.jpeg" alt="Nathalie Solon Thouary Sophrologue certifiée" />
            ...
            <div class="row link-image-row">
                <a target="_blank" href="http://www.rncp.cncp.gouv.fr/grand-public/visualisationFiche?format=fr&fiche=13375"><img class="img-responsive center-block link-image" src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/01/cncp-e1546697437540-300x235.jpg" alt="Commission nationale de la certification professionnelle Nathalie Solon Thouary" /></a>
                <a target="_blank" href="https://www.sophrologie-formation.fr"><img class="img-responsive center-block link-image" src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/01/aliotta-300x300.jpg" alt="Aliotta formations Nathalie Solon Thouary" /></a>
                <a target="_blank" href="https://www.chambre-syndicale-sophrologie.fr/titre-rncp/"><img class="img-responsive center-block link-image" src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/01/css-300x295.png" alt="Chambre syndicale de la sophrologie Nathalie Solon Thouary"/></a>
            </div>
        </div>
    </section>
<?php } ?>
