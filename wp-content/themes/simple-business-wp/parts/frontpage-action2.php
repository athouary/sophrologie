                ...
                <div class="col-md-12">
                    ...
                    <?php if ((simple_business_wp_get_option('fp-action2-button-text') != '') && (simple_business_wp_get_option('fp-action2-button-url') != '')) { ?>
                        <div class="text-center action-button">
                            <a href="<?php echo esc_url(simple_business_wp_get_option('fp-action2-button-url')); ?>" type="button" class="btn btn-primary text-center">
                                <?php echo esc_html(simple_business_wp_get_option('fp-action2-button-text')); ?>
                            </a>
                        </div>
                    <?php } ?>
                </div>
